###########################################################################
## Makefile generated for component 'final_sim_without_control'. 
## 
## Makefile     : final_sim_without_control.mk
## Generated on : Wed Nov 20 22:43:15 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/final_sim_without_control_acc.mexw64
...
PRODUCT_NAME              = final_sim_without_control
MAKEFILE                  = final_sim_without_control.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/okul_iþleri_berkay/ee463/EE463-Drive-and-Survive/birleþik_simülasyon
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = final_sim_without_control_comp.rsp
CMD_FILE                  = final_sim_without_control.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/final_sim_without_control_acc.mexw64
...
DEFINES_STANDARD = -DMODEL=final_sim_without_control -DNUMST=3 -DNCSTATES=31 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
SRCS = $(START_DIR)/slprj/accel/final_sim_without_control/final_sim_without_control_acc.c $(START_DIR)/slprj/accel/final_sim_without_control/final_sim_without_control_acc_data.c $(START_DIR)/slprj/accel/final_sim_without_control/rt_nonfinite.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = final_sim_without_control_acc.obj final_sim_without_control_acc_data.obj rt_nonfinite.obj c_mexapi_version.obj
...
final_sim_without_control_acc.obj : $(START_DIR)/slprj/accel/final_sim_without_control/final_sim_without_control_acc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


final_sim_without_control_acc_data.obj : $(START_DIR)/slprj/accel/final_sim_without_control/final_sim_without_control_acc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/accel/final_sim_without_control/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"

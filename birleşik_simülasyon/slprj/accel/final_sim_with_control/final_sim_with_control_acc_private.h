#ifndef final_sim_with_control_acc_private_h_
#define final_sim_with_control_acc_private_h_
#include "rtwtypes.h"
...
#endif
boolean_T final_sim_with_control_acc_rt_TDelayUpdateTailOrGrowBuf ( int_T *
bufSzPtr , int_T * tailPtr , int_T * headPtr , int_T * lastPtr , real_T
tMinusDelay , real_T * * uBufPtr , boolean_T isfixedbuf , boolean_T
istransportdelay , int_T * maxNewBufSzPtr ) ; real_T
final_sim_with_control_acc_rt_TDelayInterpolate ( real_T tMinusDelay , real_T

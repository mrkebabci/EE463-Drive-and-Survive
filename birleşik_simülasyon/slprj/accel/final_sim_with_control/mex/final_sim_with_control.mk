###########################################################################
## Makefile generated for component 'final_sim_with_control'. 
## 
## Makefile     : final_sim_with_control.mk
## Generated on : Wed Nov 20 23:43:58 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/final_sim_with_control_acc.mexw64
...
PRODUCT_NAME              = final_sim_with_control
MAKEFILE                  = final_sim_with_control.mk
...
COMPILER_COMMAND_FILE     = final_sim_with_control_comp.rsp
CMD_FILE                  = final_sim_with_control.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/final_sim_with_control_acc.mexw64
...
DEFINES_STANDARD = -DMODEL=final_sim_with_control -DNUMST=3 -DNCSTATES=27 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
SRCS = $(START_DIR)/slprj/accel/final_sim_with_control/final_sim_with_control_acc.c $(START_DIR)/slprj/accel/final_sim_with_control/final_sim_with_control_acc_data.c $(START_DIR)/slprj/accel/final_sim_with_control/rt_nonfinite.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = final_sim_with_control_acc.obj final_sim_with_control_acc_data.obj rt_nonfinite.obj c_mexapi_version.obj
...
final_sim_with_control_acc.obj : $(START_DIR)/slprj/accel/final_sim_with_control/final_sim_with_control_acc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


final_sim_with_control_acc_data.obj : $(START_DIR)/slprj/accel/final_sim_with_control/final_sim_with_control_acc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/accel/final_sim_with_control/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
